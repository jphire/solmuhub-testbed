...
set output '../../figures/nested3-noProcessor/processed-cpu-nested3-noProcessor.pdf'
...
plot '../../results/nested3-noProcessor/processed-cpu.out' u 2:xtic(1) ti '256x256 JPG' ls 1, \
