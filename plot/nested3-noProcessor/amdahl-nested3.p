...
set output '../../figures/final-2/amdahl-nested3.pdf'
#set output '~/Opiskelu/gradu/Figures/amdahl-types-full.pdf'

set title "Solmuhub and Amdahl's law, nested to level 3"

plot '../../data/amdahl-types-full' u 5:xtic(1) ti 'Nested-depth-3' ls 4, \
