...
set output '../../figures/dataMapped-noStringify/cpu-dataMapped-noStringify.pdf'
# set output '~/Opiskelu/gradu/Figures/cpu-dataMapped.pdf'

# set size 1.0, 1.0

set title "CPU usage using data mapper and depth 1"


plot '../../results/dataMapped-noStringify/cpu.out' u 2:3:4:xtic(1) ti '256x256 JPG' ls 1, \
