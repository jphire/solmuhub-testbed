...
set output '../../figures/dataMapped-noStringify/mem-dataMapped-noStringify.pdf'

# set logscale y 2

# set size 1.0, 1.0

set title "Memory usage using data mapper and depth 1"


plot '../../results/dataMapped-noStringify/mem.out' u 2:3:4:xtic(1) ti '256x256 JPG' ls 1, \
