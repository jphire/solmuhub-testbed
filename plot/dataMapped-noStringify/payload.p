...
set output '../../figures/dataMapped-noStringify/payload-dataMapped-noStringify.pdf'
...
n = 1000000
plot '../../results/dataMapped-noStringify/payload.out' u ($2/n):($3/n):($4/n):xtic(1) ti '256x256 JPG' ls 1, \
