...
set output '../../figures/dataMapped-noStringify/latency-dataMapped-noStringify.pdf'

# set size 1.0, 1.0

set title "Latency using data mapper and depth 1"

n = 1000
plot '../../results/dataMapped-noStringify/latency.out' u ($2/n):($3/n):($4/n):xtic(1) ti '256x256 JPG' ls 1, \
