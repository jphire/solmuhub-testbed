...
set style line 6 lc rgb "#888888" lw 2.0 ps 1.0 pi 1
set style line 7 lc rgb "#555555" lw 2.0 ps 1.0 pi 1
set style line 8 lc rgb "#111111" lw 2.0 ps 1.0 pi 1
...
set xlabel "Amount of hubs executing code"

set format y "%.0f"

set output '../../figures/final-2/amdahl-dataMapped.pdf'
#set output '~/Opiskelu/gradu/Figures/amdahl-types-full.pdf'

set title "Solmuhub and Amdahl's law, data mapped"

plot '../../data/amdahl-types-full' u 3:xtic(1) ti 'Data-mapped' ls 4, \
