...
set output '../../figures/dataMapped-noStringify/processed-cpu-dataMapped-noStringify.pdf'
...
plot '../../results/dataMapped-noStringify/processed-cpu.out' u 2:xtic(1) ti '256x256 JPG' ls 1, \
