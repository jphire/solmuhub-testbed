...
set output '../../figures/urlDataCompare/latency-urlDataCompare.pdf'

set title "Latency for one-hop execution"

n = 1000
plot '../../results/urlMapped-noStringify/latency.out' u ($10/n):($11/n):($12/n):xtic(1) ti 'Url mapped' ls 1, \
	'../../results/dataMapped-noStringify/latency.out' u ($10/n):($11/n):($12/n):xtic(1) ti 'Data mapped' ls 2
