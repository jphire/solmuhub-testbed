...
set output '../../figures/urlMapped-noStringify/processed-cpu-urlMapped-noProcessor.pdf'
...
plot '../../results/urlMapped-noProcessor/processed-cpu.out' u 2:xtic(1) ti '256x256 JPG' ls 1, \
