...
set output '../../figures/urlMapped-noProcessor/profiles-urlMapped-noProcessor.pdf'

set title "Solmuhub profile using URL mapper, no post-processing"

# define box colors
set palette rgbformulae 7,5,15
unset colorbox

plot newhistogram "2-Nodes" lt 1, '../../results/urlMapped-noProcessor/2-nodes-1-depth-profile-stacked' u (100.*$2/$9):xtic(1) lt palette frac 2/9. ti column(2), for [i=3:9] '' using (100.*(column(i)-column(i-1))/$9) lt palette frac i/9. ti column(i), \
	 newhistogram "4-Nodes" lt 1, '../../results/urlMapped-noProcessor/4-nodes-1-depth-profile-stacked' u (100.*$2/$9):xtic(1) lt palette frac 2/9. notitle, for [i=3:9] '' using (100.*(column(i)-column(i-1))/$9) lt palette frac i/9. notitle, \
	 newhistogram "8-Nodes" lt 1, '../../results/urlMapped-noProcessor/8-nodes-1-depth-profile-stacked' u (100.*$2/$9):xtic(1) lt palette frac 2/9. notitle, for [i=3:9] '' using (100.*(column(i)-column(i-1))/$9) lt palette frac i/9. notitle, \
     newhistogram "16-Nodes" lt 1, '../../results/urlMapped-noProcessor/16-nodes-1-depth-profile-stacked' u (100.*$2/$9):xtic(1) lt palette frac 2/9. notitle, for [i=3:9] '' using (100.*(column(i)-column(i-1))/$9) lt palette frac i/9. notitle, \
     newhistogram "32-Nodes" lt 1, '../../results/urlMapped-noProcessor/32-nodes-1-depth-profile-stacked' u (100.*$2/$9):xtic(1) lt palette frac 2/9. notitle, for [i=3:9] '' using (100.*(column(i)-column(i-1))/$9) lt palette frac i/9. notitle, \
     newhistogram "Local" lt 6, '../../results/urlMapped-noProcessor/0-nodes-1-depth-profile-stacked' u (100.*$2/$5):xtic(1) lt palette frac 2/5. ti column(2), for [i=3:5] '' using (100.*column(i)/$5) lt palette frac i/5. title column(i), \
