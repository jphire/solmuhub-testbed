...
set output '../../figures/urlMapped-noProcessor/latency-urlMapped-noProcessor.pdf'
...
n = 1000
plot '../../results/urlMapped-noProcessor/latency.out' u ($2/n):($3/n):($4/n):xtic(1) ti '256x256 JPG' ls 1, \
