...
#set output '~/Opiskelu/gradu/Figures/cpu-urlMapped.pdf'
set output '../../figures/urlMapped-noProcessor/cpu-urlMapped-noProcessor.pdf'
...
plot '../../results/urlMapped-noProcessor/cpu.out' u 2:3:4:xtic(1) ti '256x256 JPG' ls 1, \
