...
set output '../../figures/nested2-noProcessor/payload-nested2-noProcessor.pdf'
...
n = 1000000
plot '../../results/nested2-noProcessor/payload.out' u ($2/n):($3/n):($4/n):xtic(1) ti '256x256 JPG' ls 1, \
