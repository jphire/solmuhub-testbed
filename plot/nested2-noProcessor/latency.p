...
set output '../../figures/nested2-noProcessor/latency-nested2-noProcessor.pdf'

# set size 1.0, 1.0

set title "Latency using URL mapper and depth 2"

n = 1000
plot '../../results/nested2-noProcessor/latency.out' u ($2/n):($3/n):($4/n):xtic(1) ti '256x256 JPG' ls 1, \
