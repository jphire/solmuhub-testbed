...
set output '../../figures/final-2/amdahl-nested2.pdf'
#set output '~/Opiskelu/gradu/Figures/amdahl-types-full.pdf'

set title "Solmuhub and Amdahl's law, nested to level 2"

plot '../../data/amdahl-types-full' u 4:xtic(1) ti 'Nested-depth-2' ls 4, \
