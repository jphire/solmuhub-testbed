...
set output '../../figures/nested2-noProcessor/cpu-nested2-noProcessor.pdf'
#set output '~/Opiskelu/gradu/Figures/cpu-nested-2.pdf'

# set size 1.0, 1.0

set title "CPU usage using URL mapper and depth 2"


plot '../../results/nested2-noProcessor/cpu.out' u 2:3:4:xtic(1) ti '256x256 JPG' ls 1, \
