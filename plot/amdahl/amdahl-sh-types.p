...
set output '../../figures/amdahl-solmuhub-types.pdf'

set title "Solmuhub and Amdahl's law"

plot '../../data/amdahl-sh-types' u 2:xtic(1) ti 'Depth-1' lt 1 lc 3 lw 2, \
'' u 3:xtic(1) ti 'Depth-2' lt 3 lc 3 lw 2, \
'' u 4:xtic(1) ti 'Depth-3' lt 5 lc 3 lw 2, \
