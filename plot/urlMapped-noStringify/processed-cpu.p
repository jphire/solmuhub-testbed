...
set output '../../figures/urlMapped-noStringify/processed-cpu-urlMapped-noStringify.pdf'
...
plot '../../results/urlMapped-noStringify/processed-cpu.out' u 2:xtic(1) ti '256x256 JPG' ls 1, \
