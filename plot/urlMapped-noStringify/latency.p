...
set output '../../figures/urlMapped-noStringify/latency-urlMapped-noStringify.pdf'
...
plot '../../results/urlMapped-noStringify/latency.out' u ($2/n):($3/n):($4/n):xtic(1) ti '256x256 JPG' ls 1, \
