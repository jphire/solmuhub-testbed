...
set output '../../figures/urlMapped-noStringify/request-payload-urlMapped-noStringify.pdf'

set title "Request payloads for URL and data mapped requests"
