...
set output '../../figures/urlMapped-noStringify/payload-urlMapped-noStringify.pdf'
...
n = 1000000
plot '../../results/urlMapped-noStringify/payload.out' u ($2/n):($3/n):($4/n):xtic(1) ti '256x256 JPG' ls 1, \
